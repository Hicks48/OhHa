...
public class Launch {
    public static void main(String []args)
    {
        ...
        Window fwin = new Window(new Complex_Number(0.0,0.0),0.5,new Julia(new Complex_Number(-0.726895347709114071439,0.188887129043845954792),"Julia",200),800,800,0,0,Color.WHITE,Color.BLACK,null);
